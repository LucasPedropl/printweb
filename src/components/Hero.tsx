      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <button className="px-8 py-4 rounded-2xl text-lg font-bold text-white border border-white/20 hover:bg-white/10 backdrop-blur-md transition-all flex items-center justify-center gap-2">
              Ver Demonstração
            </button>
          </div>
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 border-t border-white/20 pt-8">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-emerald-50 font-medium">Mobile First</span>
            </div>
            <div className="flex items-center gap-3">
              <Printer className="text-emerald-400 w-5 h-5" />
              <span className="text-sm text-emerald-50 font-medium">Multi-Impressora</span>
            </div>
            <div className="flex items-center gap-3">
              <Layout className="text-emerald-400 w-5 h-5" />
              <span className="text-sm text-emerald-50 font-medium">Customizável</span>
            </div>
          </div>
        </motion.div>
      </div>
